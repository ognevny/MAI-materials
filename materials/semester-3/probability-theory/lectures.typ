...
#figure(
  ...
  caption: [Экспиремент с монеткой],
)
...
==== Про зависимость и кореллированность СВ
...
Средне-квадратическая сходимость $ X_n stretch(->)_(n->oo)^"С.К." X "если" lim_(n->oo) M(abs(X_n - X)^2) = 0 $
