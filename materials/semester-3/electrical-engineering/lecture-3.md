...
i = <a>I<sub>m</sub>sin(&omega;t + &psi;<sub>i</sub>) - сила тока, где I<sub>m</sub> - амплитудная сила тока; &omega = 2&pi;f \[с<sup>-1</sup>\] - частота; &psi<sub>i</sub> - начальная фаза; (&omega;t + &psi;<sub>i</sub>)</a> - фаза
