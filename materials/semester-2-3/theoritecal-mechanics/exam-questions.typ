...
Кинетический момент материальной точка: $ K_z = plus.minus h m V, $ где h - длина перпендикуляра, проведенного от оси к вектору скорости
...
Принцип виртуальных перемещений (использовать, когда система находится в равновесии): $ sum_j (ov(F)_j, delta ov(r)_j) plus.minus M delta phi = 0 $
