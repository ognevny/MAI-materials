...
#show: conf.with(
  title: "Лекции по Теоретической механике",
  description: "Конспект лекций Зародова В.К. по Теоретической механике",
...
Силы инерции: $ ov(Phi)_e = -m ov(W)_e, space ov(Phi)_c = -m ov(W)_c $
...
#grid(
  ...
  [
    #figure(
      image("source-figures/lect0-1-2.png"),
    )
  ],
)
...
#grid(
  ...
  [
    #figure(
      image("source-figures/lect0-1-5.png"),
    )
  ],
)
...
$display(
  dv(ov(K)_(j O), t) = dv(, t) sum_j [ov(r)_j, m_j ov(V)_j] = sum_j dv(, t) [ov(r)_j, m_j ov(V)_j] = sum_j ([dv(ov(r)_j, t), m_j ov(V)_j] + [ov(r)_j, dv((m_j ov(V)_j), t)]) = sum_j (0 + ov(M)_0 (ov(F)_j^((e))))
) \
...
#grid(
  ...
  [
    #figure(
      image("source-figures/lect0-1-6.png"),
    )
  ],
)
...
#grid(
  ...
  [
    #figure(
      image("source-figures/lect0-1-7.png"),
    )
  ],
)
...
#grid(
  ...
  [
    #figure(
      image("source-figures/lect0-1-8.png"),
    )
  ],
)
...
#grid(
  ...
  [
    #figure(
      image("source-figures/lect0-1-9.png"),
    )
  ],
)
...
#grid(
  ...
  [
    #figure(
      image("source-figures/lect0-1-11.png"),
    )
  ],
)
...
#grid(
  ...
  [
    #figure(
      image("source-figures/lect0-1-14.png"),
      caption: [],
    ) <работа>
    #figure(
...
+ Поступательное движение ($forall j: ov(V)_j = ov(V)$)
...
+ Вращательное движение ($ov(V)_j = [ov(omega), ov(r)_j]$)
...
#grid(
  ...
  [
    #figure(
      image("source-figures/lect0-1-17.png"),
    )
  ],
)
...
#grid(
  ...
  [
    #figure(
      image("source-figures/lect0-1-18.png"),
    )
  ],
)
...
#grid(
  ...
  [
    ...
    $ V_P = 0 space dash "М.Ц.С"; space dif' A (ov(R)) = (ov(R), ov(V)_P) dif t = 0 $
  ],
  [
    #figure(
      image("source-figures/lect0-1-20.png"),
    )
  ],
)
...
+ Однородное поле силы тяжести $ Pi = m g z $
...
#grid(
  ...
  [
    #figure(
      image("source-figures/lect0-1-22.png"),
    )
  ],
)
...
#grid(
  ...
  [
    #figure(
      image("source-figures/lect2-fig3.png"),
      caption: [],
    ) <плоскопараллел>
  ],
)
...
#grid(
  ...
  [
    #figure(
      image("source-figures/lect2-fig8.png"),
    )
  ],
  [
    ...
    + $sin(alpha) = 0, T_1 = m g$
    + $sin(alpha) != 0, T_2 = m omega^2 l, T_2 cos(alpha) = m g$,
...
#grid(
  ...
  [
    #figure(
      image("source-figures/lect3-fig3.png"),
      caption: [],
    ) <стационарный>
  ],
)
...
#grid(
  ...
  [
    #figure(
      image("source-figures/lect3-fig5.png"),
      caption: [],
    ) <виртточка>
  ],
)
...
#grid(
  ...
  [
    #figure(
      image("source-figures/lect3-fig6.png"),
    )
  ],
)
...
#grid(
  ...
  [
    #figure(
      image("source-figures/lect3-fig7.png"),
    )
  ],
)
...
delta q_i space dash "независимы" => Q_i = 0 space (i = 1...n) space dash "уравнение равновесия голономных систем" \
Q_i = -pdv(Pi, q_i) \
...
$n = 1 \
pdv(Pi, q) = 0 => q^* \
evaluated(pdv(Pi, q, 2))_(q^*) = cases(> 0 space dash min space dash "устойчивый", < 0 space dash max space dash "неустойчивый")$
...
$ A = sqrt(C_1^2 + C_2^2) space dash "Амплитуда", x = A sin(k t + epsilon), $
