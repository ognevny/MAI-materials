...
Теорема умножения функций распределения: функцию распределения двумерной СВ можно представить как произведение <a>F(x, +&infin;) = F<sub>1</sub>(x)</a> на функцию распределения Y при условии x.
