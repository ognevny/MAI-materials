...
$
  ov(V)_C = (dif ov(r)_C)/(dif t) = display(dif/(dif t) (sum_j m_j ov(r)_j)) / display(dif/(dif t) sum_j m_j) = display(sum_j m_j (dif ov(r)_j)/(dif t))/display(sum_j m_j) = (display(sum_j) m_j ov(V)_j)/M
$
